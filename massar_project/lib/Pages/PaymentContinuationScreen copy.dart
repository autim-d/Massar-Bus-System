...
class PaymentContinuationScreen extends StatelessWidget {
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsGeometry.only(right: 165),
                        child: Container(
                          width: 24,
                          height: 24,
                          decoration: BoxDecoration(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Image.asset("assets/images/Vector.png", width: 60),
                            SizedBox(width: 10),
                            const Text(
                              "Mandiri VA",
                              style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text(
                              "الدفع يتم فقط عن طريق بنك بن دول ولا يمكن استبداله بطرق أخرى",
                              style: TextStyle(
                                fontSize: 14,
                                color: Color(0xff667085),
  ...
  Widget _buildStepDivider() {
    return SizedBox(
      child: Container(height: 2, width: 75, color: Colors.grey.shade300),
    );
  }
}
