...
import 'package:massar_project/Bawazir_Screens/Pages/VerificationMethodPage.dart';
import 'package:massar_project/Bawazir_Screens/Pages/home.dart';
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(color: const Color(0xFF2563EB), width: 1.6),
            ),
          ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // النص المتمركز: "لم تستلم الرسالة؟ أعد الإرسال"
                Center(
                  child: RichText(
                    textAlign: TextAlign.center,
                    text: TextSpan(
