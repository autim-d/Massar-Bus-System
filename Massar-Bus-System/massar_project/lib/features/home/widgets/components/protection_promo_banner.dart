                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        ...
                        color: _isProtected ? AppColors.mainButton : const Color(0xFFD0D5DD),
                        size: 20,
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(LucideIcons.shieldCheck, size: 16, color: AppColors.textPrimary),
                ...
                InkWell(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Icon(LucideIcons.shieldClose, size: 16, color: AppColors.textPrimary),
                      const SizedBox(width: 8),
                      Text(
                        'لا اريد الحمايه',
                        style: TextStyle(
